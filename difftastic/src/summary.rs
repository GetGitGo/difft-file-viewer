...
/// Syntax tree node span for GUI gutter block selection (`difft --display json`).
#[derive(Debug, Clone, PartialEq, Eq, Serialize)]
pub(crate) struct SyntaxBlock {
    pub id: u32,
...
pub(crate) struct DiffResult {
    ...
    pub(crate) lhs_syntax_blocks: Vec<SyntaxBlock>,
    pub(crate) rhs_syntax_blocks: Vec<SyntaxBlock>,
}
